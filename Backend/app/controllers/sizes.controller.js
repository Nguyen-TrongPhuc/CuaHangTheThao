...
exports.findAll = async (req, res, next) => {
    try {
        ...
        console.error("Lỗi findAll sizes:", error);
...
exports.findOne = async (req, res, next) => {
    try {
        ...
        if (!document) return next(new ApiError(404, "Size not found"));
        return res.send(document);
    } catch (error) { return next(new ApiError(500, "Error retrieving size")); }
};
...
exports.update = async (req, res, next) => {
    ...
    } catch (error) { return next(new ApiError(500, "Error updating size")); }
};
...
exports.delete = async (req, res, next) => {
    ...
    } catch (error) { return next(new ApiError(500, "Could not delete size")); }
};